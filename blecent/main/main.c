...
// #define myPEER_ADDR (uint8_t*) {0x84, 0xF7, 0x03, 0x07, 0xCE, 0xA2}

static const char *tag = "NimBLE_BLE_CENT";
static int blecent_gap_event(struct ble_gap_event *event, void *arg);
static uint8_t peer_addr[6];
//static uint8_t* my_peer_addr = {0x84, 0xF7, 0x03, 0x07, 0xCE, 0xA2};
...
//               &peer_addr[2], &peer_addr[1], &peer_addr[0]);
        if (memcmp(my_peer_addr, disc->addr.val, sizeof(disc->addr.val)) != 0) {
            return 0;
        }
    }
